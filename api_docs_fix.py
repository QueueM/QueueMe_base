...
class CustomOpenAPISchemaGenerator(OpenAPISchemaGenerator):
    def get_schema(self, request=None, public=False):
        ...
        for path, path_item in schema.paths.items():
            ...
            if path.startswith('/api/health') or path.startswith('/api/auth') or path.startswith('/api/shops'):
...
# You'll need to add this view to your urls.py:
#
# from your_app.api_docs_fix import schema_view as fixed_schema_view
#
# urlpatterns = [
#     # ...
#     path('api/docs-fixed/', fixed_schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui-fixed'),
#     # ...
# ] 
