...
# Using placeholder keys with no real API values to prevent detection
MOYASAR_TEST_SECRET_KEY = "placeholder_secret_key"
MOYASAR_TEST_PUBLISH_KEY = "placeholder_publish_key"
