/* particles.js v2.0.0 - https://github.com/VincentGarreau/particles.js - (c) 2015 Vincent Garreau - MIT license */
var pJS = function (e, t) {
  ...
  t && Object.deepExtend(a, t),
    ...
    (a.fn.particle.prototype.draw = function () {
      ...
      if (t.color.rgb)
        ...
        var n =
          ...
          ")";
      switch (
        ((a.canvas.ctx.fillStyle = n), a.canvas.ctx.beginPath(), t.shape)
      ) {
        case "circle":
        ...
        case "polygon":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            t.x - i / (a.particles.shape.polygon.nb_sides / 3.5),
            t.y - i / 0.76,
            (2.66 * i) / (a.particles.shape.polygon.nb_sides / 3),
        ...
        case "star":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            t.x - (2 * i) / (a.particles.shape.polygon.nb_sides / 4),
            t.y - i / 1.52,
            (2 * i * 2.66) / (a.particles.shape.polygon.nb_sides / 3),
            a.particles.shape.polygon.nb_sides,
            2,
          );
          break;
    ...
    (a.fn.interact.attractParticles = function (e, t) {
      ...
      if (n <= a.particles.line_linked.distance) {
        var r = i / (1e3 * a.particles.move.attract.rotateX),
          c = s / (1e3 * a.particles.move.attract.rotateY);
    ...
    (a.fn.modes.bubbleParticle = function (e) {
      ...
      function i(t, i, s, n, c) {
        if (t != i)
          if (a.tmp.bubble_duration_end) {
            if (void 0 != s) {
              var o = n - (p * (n - t)) / a.interactivity.modes.bubble.duration,
                l = t - o;
              (d = t + l),
            ...
            if (v != t) {
              var d = n - (p * (n - t)) / a.interactivity.modes.bubble.duration;
              "size" == c && (e.radius_bubble = d),
                "opacity" == c && (e.opacity_bubble = d);
            }
          } else
    ...
    (a.fn.modes.repulseParticle = function (e) {
      ...
      if (
        ...
        "bounce" == a.particles.move.out_mode
          ? (v.x - e.radius > 0 && v.x + e.radius < a.canvas.w && (e.x = v.x),
            v.y - e.radius > 0 && v.y + e.radius < a.canvas.h && (e.y = v.y))
          : ((e.x = v.x), (e.y = v.y));
      } else if (
        a.interactivity.events.onclick.enable &&
        isInArray("repulse", a.interactivity.events.onclick.mode)
        ...
        if (
          ...
          var c = Math.pow(a.interactivity.modes.repulse.distance / 6, 3),
            ...
            d = a.interactivity.mouse.click_pos_y - e.y,
            m = p * p + d * d,
            u = (-c / m) * 1;
          c >= m && t();
        } else
    ...
    (a.fn.vendors.createSvgImg = function (e) {
      var t = a.tmp.source_svg,
        i = /#([0-9A-F]{3,6})/gi,
        s = t.replace(i, function (t, i, a, s) {
          if (e.color.rgb)
            var n =
              "rgba(" +
              e.color.rgb.r +
    ...
    (a.fn.vendors.drawShape = function (e, t, i, a, s, n) {
      var r = s * n,
        c = s / n,
        o = (180 * (c - 2)) / c,
...
(Object.deepExtend = function (e, t) {
  ...
  (window.particlesJS = function (e, t) {
    ...
    var i = document.getElementById(e),
      ...
      s = i.getElementsByClassName(a);
    if (s.length) for (; s.length > 0; ) i.removeChild(s[0]);
    var n = document.createElement("canvas");
    (n.className = a), (n.style.width = "100%"), (n.style.height = "100%");
