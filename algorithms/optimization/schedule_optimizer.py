...
class ScheduleOptimizer:
    ...
    def _apply_staff_preferences(
        ...
        """
        Adjust the schedule to respect staff preferences where possible.

        This is a simplified implementation that tries to adjust shifts
        ...
        for staff_id, preferences in staff_preferences.items():
            ...
            for date_str in list(adjusted_schedule.keys()):
                ...
                if weekday in unavailable_days and staff_id in adjusted_schedule.get(
                    date_str, {}
                ):
