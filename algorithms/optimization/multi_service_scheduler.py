...
class MultiServiceScheduler:
    ...
    def __init__(
        ...
        Args:
            ...
            allow_parallel_services: Whether to allow services to be performed in parallel (by different specialists)
            max_total_duration: Maximum total duration for all services including breaks (None = unlimited)
        """
