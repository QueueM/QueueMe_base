                    ...
                    result["conflicts"].append(
                        {
                            ...
                            "description": f"Specialist {new_booking['specialist_id']} is already booked during this time",
                    ...
                    result["conflicts"].append(
                        {
                            ...
                            "description": f"Resources {', '.join(common_resources)} are already booked during this time",
                            "conflicting_booking_id": booking.get("id"),
                        }
                    )
                    ...
                    result["conflicts"].append(
                        {
                            ...
                            "description": f"Specialist {specialist_id} is not available during this time",
                        }
                    )
                ...
                if resource_slots:
                    ...
                    if not is_available:
                        ...
                        result["conflicts"].append(
                            {
                                "type": "availability_conflict",
                                "description": f"Resource {resource_id} is not available during this time",
                            }
                        )
                            ...
                            result["conflicts"].append(
                                {
                                    ...
                                    "description": f"Service {new_booking.get('service_id')} depends on service {dep_service_id} which must be completed before",
                                }
                            )
                ...
                if specialist_slots:
                    ...
                    if not is_available:
                        ...
                        result["conflicts"].append(
                            {
                                "type": "availability_conflict",
                                "description": f"Specialist {specialist_id} is not available for booking {i}",
                                "bookings": [i],
                            }
                        )
                        ...
                        for dep_service_id in depends_on:
                            ...
                            if not dep_satisfied:
                                ...
                                result["conflicts"].append(
                                    {
                                        "type": "dependency_violation",
                                        "description": f"Service {service_id} depends on service {dep_service_id} which must be completed before",
                                        "bookings": [i],
                                    }
                                )
