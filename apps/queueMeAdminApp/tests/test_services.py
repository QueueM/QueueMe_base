...
class SupportServiceTest(TestCase):
    ...
    def test_create_ticket(self):
        ...
        notifications = AdminNotification.objects.filter(
            title__contains=ticket.reference_number
        )
    ...
    def test_assign_ticket(self):
        ...
        messages = SupportMessage.objects.filter(
            ticket=self.ticket, is_internal_note=True
        )
        self.assertEqual(messages.count(), 1)
    ...
    def test_update_ticket_status(self):
        ...
        updated = SupportService.update_ticket_status(
            self.ticket, "resolved", self.admin
        )
    ...
    def test_update_ticket_on_new_message(self):
        ...
        # Update ticket
        updated = SupportService.update_ticket_on_new_message(
            self.ticket.id, self.admin
        )
