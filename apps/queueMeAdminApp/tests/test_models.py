...
class SystemSettingModelTest(TestCase):
    ...
    def test_ordering(self):
        SystemSetting.objects.create(key="ANOTHER_KEY", value="another value", category="security")
...
class SupportTicketModelTest(TestCase):
    ...
    def test_string_representation(self):
        self.assertEqual(str(self.ticket), f"{self.ticket.reference_number} - Test Ticket")
    ...
    def test_reference_number_generation(self):
        ...
        self.assertNotEqual(self.ticket.reference_number, another_ticket.reference_number)
...
class SupportMessageModelTest(TestCase):
    ...
    def test_string_representation(self):
        expected = f"{self.ticket.reference_number} - {self.user} - {self.message.created_at}"
...
class AuditLogModelTest(TestCase):
    ...
    def test_string_representation(self):
        self.assertEqual(str(self.log), f"Create Shop {self.log.entity_id} by {self.user}")
