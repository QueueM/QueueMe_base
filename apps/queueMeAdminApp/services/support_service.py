...
class SupportService:
    ...
    def get_ticket_stats():
        ...
        category_counts = SupportTicket.objects.values("category").annotate(
            count=Count("id")
        )
        ...
        unassigned_count = SupportTicket.objects.filter(
    ...
    @staticmethod
    def search_tickets(
        query, status=None, category=None, priority=None, assigned_to=None
    ):
        """
