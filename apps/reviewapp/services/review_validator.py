...
class ReviewValidator:
    ...
    def validate_review_data(cls, data: Dict[str, Any]) -> None:
        ...
        if cls._contains_inappropriate_content(title) or cls._contains_inappropriate_content(content):
    ...
    def _is_duplicate_content(cls, content: str) -> bool:
        ...
        for review_content in similar_reviews:
            if cls._calculate_similarity(normalized, review_content) > 0.8:  # 80% similarity threshold
                # Cache the result
